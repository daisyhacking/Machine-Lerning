...
return_to_p <- stocks[-seq(1,365),]
return_to_p <- rbind(return_to_p,x)
stocks$stock_tp <- return_to_p$Agric
stocks <- stocks[1:11831, ]
...
Agric_linear_lag365<-ggplot(pred_lm_fix) + geom_line( aes( x =  Date, y = RMSE_diff, colour = "Mean -Linear")) 
ggsave("Agric_linear_lag365.jpg", plot = Agric_linear_lag365)

#save the outcome of computer industry-linear-lag365
write.csv(pred_lm_fix,'linear_Agriculture_lag365.csv')
...
#save outcome
write.csv(pred_lasso,'pred_lasso_Agriculture_lag365.csv')
Agric_lasso_lag365<-ggplot(pred_lasso) + geom_line( aes( x =  Date, y = RMSE_diff, colour = "Mean - Lasso")) 
ggsave("Agric_lasso_lag365.jpg", plot = Agric_lasso_lag365)
...
#save outcome for rf
write.csv(pred_rf, "RF_Agriculture_lag365.csv")

Agric_rf_lag365<- ggplot(pred_rf) + geom_line( aes( x =  Date, y = RMSE_diff, colour = "Mean - Random Forest")) 
ggsave("Agric_rf_lag365.jpg", plot = Agric_rf_lag365)
...
#save outcome
write.csv(pred_svm,'svm_Agriculture_lag365.csv')
Agric_svm_lag365<-ggplot(pred_svm) + geom_line( aes( x =  Date, y = RMSE_diff, colour = "Mean - Svm")) 
ggsave("Agric_svm_lag365.jpg", plot = Agric_svm_lag365)
