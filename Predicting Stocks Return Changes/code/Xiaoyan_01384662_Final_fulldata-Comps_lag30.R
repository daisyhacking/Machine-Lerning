...
Comps_linear_lag30<-ggplot(pred_lm_fix) + geom_line( aes( x =  Date, y = RMSE_diff, colour = "Mean -Linear")) 
ggsave("Comps_linear_lag30.jpg", plot = Comps_linear_lag30)

#save the outcome of computer industry-linear-lag365
write.csv(pred_lm_fix,'linear_Comps_lag30.csv')
...
#save outcome
write.csv(pred_lasso,'pred_lasso_Comps_lag30.csv')
Comps_lasso_lag30<-ggplot(pred_lasso) + geom_line( aes( x =  Date, y = RMSE_diff, colour = "Mean - Lasso")) 
ggsave("Comps_lasso_lag30.jpg", plot = Comps_lasso_lag30)
...
#save outcome for rf
write.csv(pred_rf, "RF_Comps_lag30.csv")
Comps_rf_lag30<- ggplot(pred_rf) + geom_line( aes( x =  Date, y = RMSE_diff, colour = "Mean - Random Forest")) 
ggsave("Comps_rf_lag30.jpg", plot = Comps_rf_lag30)
...
#save outcome
write.csv(pred_svm,'Comps_Drugs_lag30.csv')
Comps_svm_lag30<-ggplot(pred_svm) + geom_line( aes( x =  Date, y = RMSE_diff, colour = "Mean - Svm")) 
ggsave("Comps_svm_lag30.jpg", plot = Comps_svm_lag30)
