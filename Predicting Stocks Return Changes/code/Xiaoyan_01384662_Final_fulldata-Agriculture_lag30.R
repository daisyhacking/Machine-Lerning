...
#save outcome
write.csv(pred_svm,'svm_Agriculture_lag30.csv')
Agric_svm_lag30<-ggplot(pred_svm) + geom_line( aes( x =  Date, y = RMSE_diff, colour = "Mean - Svm")) 
ggsave("Agric_svm_lag30.jpg", plot = Agric_svm_lag30)
