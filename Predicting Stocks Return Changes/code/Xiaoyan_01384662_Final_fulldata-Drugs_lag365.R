...
Drugs_linear_lag365<-ggplot(pred_lm_fix) + geom_line( aes( x =  Date, y = RMSE_diff, colour = "Mean -Linear")) 
ggsave("Drugs_linear_lag365.jpg", plot = Drugs_linear_lag365)

#save the outcome of computer industry-linear-lag365
write.csv(pred_lm_fix,'linear_Drugs_lag365.csv')
...
#save outcome
write.csv(pred_lasso,'pred_lasso_drugs_lag365.csv')
Drug_lasso_lag365<-ggplot(pred_lasso) + geom_line( aes( x =  Date, y = RMSE_diff, colour = "Mean - Lasso")) 
ggsave("Drug_lasso_lag365.jpg", plot = Drug_lasso_lag365)
...
#save outcome for rf
write.csv(pred_rf, "RF_Drugs_lag365.csv")

Drugs_rf_lag365<- ggplot(pred_rf) + geom_line( aes( x =  Date, y = RMSE_diff, colour = "Mean - Random Forest")) 
ggsave("Drugs_rf_lag365.jpg", plot = Drugs_rf_lag365)
...
#save outcome
write.csv(pred_svm,'svm_Drugs_lag365.csv')
Drugs_svm_lag365<-ggplot(pred_svm) + geom_line( aes( x =  Date, y = RMSE_diff, colour = "Mean - Svm")) 
ggsave("Drugs_svm_lag365.jpg", plot = Drugs_svm_lag365)
